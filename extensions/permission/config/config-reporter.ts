import type { ResolvedPolicyPaths } from "../policy/permission-manager";
...
export function buildResolvedConfigLogEntry(options: BuildResolvedConfigLogEntryOptions): ResolvedConfigLogEntry {
  return {
    ...options.policyPaths,

...
import { getSubagentSessionRegistry, type SubagentSessionInfo, SubagentSessionRegistry } from "#src/subagent-registry";
...
describe("getSubagentSessionRegistry (process-global accessor)", () => {
  afterEach(() => {
    Reflect.deleteProperty(globalThis as Record<symbol, unknown>, REGISTRY_KEY);
  });

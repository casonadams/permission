...
describe("describeSkillInputGate", () => {
  it("sets surface to 'skill'", () => {
    const descriptor = describeSkillInputGate("librarian", null, makeSkillCheck("allow"));
  ...
  it("sets promptDetails source to 'skill_input' with skill name and agent", () => {
    const descriptor = describeSkillInputGate("librarian", "code-agent", makeSkillCheck("ask"));
  ...
  it("sets decision surface to 'skill' and value to the skill name", () => {
    const descriptor = describeSkillInputGate("my-skill", null, makeSkillCheck("allow"));

...
describe("canonicalizePath", () => {
  ...
  test("walks Windows drive-letter paths without rewriting the drive root as POSIX", () => {
    realpathSync
      .mockImplementationOnce(() => {
        throw enoent("C:\\Users\\Ada\\project\\new-file.ts");
      })
      .mockReturnValueOnce("C:\\Users\\Ada\\real-project");

    expect(canonicalizePath("C:\\Users\\Ada\\project\\new-file.ts")).toBe("C:\\Users\\Ada\\real-project\\new-file.ts");
    expect(realpathSync).toHaveBeenNthCalledWith(1, "C:\\Users\\Ada\\project\\new-file.ts");
    expect(realpathSync).toHaveBeenNthCalledWith(2, "C:\\Users\\Ada\\project");
  });
});

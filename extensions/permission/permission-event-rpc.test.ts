...
import { type PermissionRpcDeps, registerPermissionRpcHandlers } from "#src/permission-event-rpc";
import type { PermissionsCheckReplyData, PermissionsRpcReply } from "#src/permission-events";
import {
